//Read json project from mit server
...
//read json project frmo local json file
var loadProjectFromLocal = function () {
  
   
    var url = 'http://localhost/scratch-vm-version3/public_html/playground/initiaProject2.json';
...
//        location.reload();
//    };
    //loadProjectFromLocal();//load from local json file
    loadProject(); //to read from mit server

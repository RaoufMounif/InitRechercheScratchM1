    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6" style="margin-outside: 0%">
                ...
                <button id="load" onclick="start()" class="btn btn-primary btn-lg btn-block">Load</button>
                <div id="projectButtons" class="row">
                    <div class="col-md-6">
                        <button id="greenflag" class="btn btn-success btn-lg btn-block" style="visibility: hidden">Start</button>
                    </div>

                    <div class="col-md-6">
                        <button id="stopall" class="btn btn-danger  btn-lg btn-block" style="visibility: hidden">Stop</button>
                    </div>
                </div>
    ...
    <script src="js/playground.js"></script>
            ...
            <script>
                function start() {
                    ...
                    alert('Vous pouvez commencer à commenter ce védio');

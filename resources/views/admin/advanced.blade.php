...
@section('content')
    <div class="row">
        ...
        <div class="col">
            ...
            <button type="submit" class="btn btn-success btn-block" onclick="generate()">Générer</button>
        </div>
        <div class="col " >
        ...
        <div class="col " >
            ...
            <legand><strong>Get Commentaires pour l'utilisateur ID</strong></legand><hr>
            <form method="POST" action="/test_admin/comment/user_id" >
                {{csrf_field()}}
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">User ID</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <div class="offset-sm-2 col-sm-10">
                        <button type="submit" class="btn btn-primary">Get Commentaires</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        function generate() {
            window.location.pathname = '/test_admin/corpus';
        }
    </script>
@endsection
